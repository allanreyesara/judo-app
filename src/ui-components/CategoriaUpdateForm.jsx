...
export default function CategoriaUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPeso_max(cleanValues.peso_max);
    setPeso_min(cleanValues.peso_min);
    setErrors({});
  };
  const [categoriaRecord, setCategoriaRecord] = React.useState(categoria);
  React.useEffect(() => {
