...
export default function EntrenadorUpdateForm(props) {
  const {
    id: idProp,
    entrenador,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = entrenadorRecord
      ? { ...initialValues, ...entrenadorRecord }
      : initialValues;
  ...
  const [entrenadorRecord, setEntrenadorRecord] = React.useState(entrenador);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Entrenador, idProp)
        : entrenador;
      setEntrenadorRecord(record);
    };
    queryData();
  }, [idProp, entrenador]);
  React.useEffect(resetStateValues, [entrenadorRecord]);
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Entrenador.copyOf(entrenadorRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "EntrenadorUpdateForm")}
      {...rest}
    >
      <TextField
        label="Nombre"
